...
<div class="container">
    <h1 class="welcome text-center">Igreja Pentecostal Lâmpada Para os Meus Pés</h1>
    ...
    <div class="card card-container">
        ...
        <form   action="/login" method="POST" class="form-signin">
            ...
            <input type="text" id="inputEmail" name="email" class="login_box" placeholder="E-mail" required autofocus>
            <p class="input_title">Senha</p>
            <input type="password" name="password" id="inputPassword" class="login_box" placeholder="Senha" required>
